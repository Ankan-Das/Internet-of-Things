...
const char* ssid = "dongle"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "TEST0562"; // Your Wifi password, in case you have open network comment the whole statement.
